(function($) {
    ...
    const buildTable = function(data) {
        ...
        $.each(data, function(key, image) {
            if (mobile !== true){
                ...
                $imageTable.append('<div class="imageContainer">' +
    ...
    /*
    $imageTable.append('<div class="imageContainer" style="padding-left: 0%;">' +
                    '<img src="' + image.path + '" class="image" alt="' + image.alt + '" style="min-width:' + ($(window).width()/1.3) + 'px")>' +
                    '<div class="middle" style="min-width:' + ($(window).width()/1.3) + 'px")>' +
                    '<div class="text">' + image.description + '</div> ' +
                    '</div> ' +
    ...
    const handlePopUp = function(e) {
        myPopup = new Popup({
            ...
            content: '<img src="' + e.currentTarget.src + '" alt="' + e.currentTarget.alt + '" style="max-width: ' + ($(window).width()/1.5) + 'px; max-height: ' + ($(window).height()/1.5) + 'px;">',
